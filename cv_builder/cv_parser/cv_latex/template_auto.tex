...
\begin{document}
\name{samii Fakhfakh}
\tagline{ETUDIANT INGENIEUR EN INFORMATIQUE}
\photo{3cm}{image}
\personalinfo{
...
\cvsection{EDUCATION}
\cvevent{}{Etudiant ingenieur informatique | Institut des sciences et techniques des yvelines - France }{2017 - Aujourd'hui} {}
\begin{itemize}
...
\cvevent{}{STAGIAIRE | Stage - Crystalchain - Paris }{AVRIL 2019 - EN COURS} {}
\begin{itemize}
	\item En cours . 
\end{itemize}
...
\end{itemize}
\cvsection{PROJETS}
\cvevent{}{Projet universitaire NodeJs | Systéme de gestion des tâches et pense-bête  }{MAI 2019 - JUIN 2019} {}
\begin{itemize}
...
\begin{itemize}
	\item Technologies: NodeJs , Html , css , javascript 
\end{itemize}
\cvevent{}{Projet freelance - upWork | Mise en place d’un script d’analyse technique et fondamentale ( Scrapping ) automatique , de décision et de simulation d’options binaires . }{JAN 2019} {}
\begin{itemize}
...
\begin{itemize}
	\item Technologies: C , sdl 
\end{itemize}
\cvevent{}{Projet PFE Java | Application desktop en Java pour la détection des véhicules avec la reconnaissance des plaques d’immatriculation. }{FEV 2017 - JUIN 2017} {}
\begin{itemize}
